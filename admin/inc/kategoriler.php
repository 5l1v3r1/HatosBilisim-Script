...
<div class="tab_container">
	...
	<tbody> 
		...
		<tr> 
			...
			<td>
				<a href="<?php echo URL; ?>/admin/index.php?do=kategori_duzenle&id=<?php echo $row["kategori_id"]; ?>" title="Düzene"><img src="images/icn_edit.png" alt=""/></a>
				<a onclick="return confirm('Kategoriyi Silmek İstediğinize Emin misiniz?');" style="margin-left: 10px" href="<?php echo URL; ?>/admin/index.php?do=kategori_sil&id=<?php echo $row["kategori_id"]; ?>" title="Sil"><img src="images/icn_trash.png" alt=""/></a>
			</td> 
		</tr>
		<?php } ?>
	</tbody> 
