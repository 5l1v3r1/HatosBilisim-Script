		...
		<form action="" method="post">
			<div class="module_content">
					...
					if (mysql_affected_rows()){
						...
						while ($alanRow = mysql_fetch_array($alanQuery)){
							...
							if ($alanRow["alan_tip"] == 1){
								...
								$form = '<textarea rows="5" name="alan_'.$alanRow["alan_id"].'">'.$value.'</textarea>';
							}
							echo '<fieldset>
					...
					<fieldset>
						...
						<textarea class="OEditor" rows="3" name="konu_anasayfa_aciklama"><?php echo ss($konu[0]); ?></textarea>
					</fieldset>
					<fieldset>
						<label>KONU FULL AÇIKLAMASI</label>
						<textarea class="OEditor" rows="10" name="konu_full_aciklama"><?php echo ss($konu[1]); ?></textarea>
					</fieldset>
					<fieldset>
